    ...
    <AuroraBackground className="relative flex items-center justify-center min-h-screen bg-black/60 text-white">
      ...
      <div className="bg-white/5 backdrop-blur-md shadow-2xl rounded-2xl p-10 w-full max-w-md">
        ...
        <p className="text-gray-400 text-center mb-8 text-sm">
          Sign up to start coding smarter with{" "}
        ...
        <form onSubmit={handleSignup} className="space-y-5">
          ...
          <button
            type="submit"
            className="w-full bg-purple-600 hover:bg-purple-700 transition-colors py-2 rounded-md text-sm font-semibold"
            disabled={loading}
          >
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-2 bg-white/10 hover:bg-white/20 transition-colors py-2 rounded-md text-sm font-semibold text-white border border-white/20 mt-2"
          >
            <svg
              width="20"
              height="20"
